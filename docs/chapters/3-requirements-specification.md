...
|     US08      | Recopilación de datos de la humedad del aire      | Como usuario, deseo que la aplicación PlantGuard recopile datos de humedad del aire para tener una comprensión completa del entorno de mis plantas en casa                                                                                                 |  EP01   |
...
|     US15      | Seguridad y privacidad de datos en la nube          | Como usuario, espero que mis datos de cuidado de plantas estén seguros y protegidos en la nube de la aplicación PlantGuard, con medidas de privacidad adecuadas para mantener la confidencialidad de mis registros                 |  EP03   |
...
|    1    |     US08      | Recopilación de datos de la humedad del aire | Como usuario, deseo que la aplicación PlantGuard recopile datos de humedad del aire para tener una comprensión completa del entorno de mis plantas en casa                                                                           |      5       |
|    2    |     US09      | Registro de niveles de luz natural     | Como usuario, quiero que se registren los niveles de luz natural en la aplicación PlantGuard para asegurarme de que mis plantas estén recibiendo la cantidad adecuada de luz solar                                                                               |      5       |
|    2    |     US11      | Sugerencias de nutrientes y fertilizantes     | Como usuario, necesito recomendaciones de nutrientes y fertilizantes adecuados para cada tipo de planta en mi jardín, según los datos registrados                                                                               |      5       |
...
|    6    |     US10      | Consejos para la elección de plantas                    | Como usuario, deseo recibir consejos de selección de plantas en función de las condiciones de mi hogar y mis preferencias personales |      3       |
|    6    |     US12      | Alertas de plagas y enfermedades                    | Como usuario, quiero ser alertado por la aplicación PlantGuard en caso de detectar signos de plagas o enfermedades en mis plantas y recibir consejos sobre cómo tratarlos |      3       |
...
|    7    |     US13      | Compartir datos con otros usuarios          | Como usuario, quiero tener la opción de compartir mis datos de cuidado de plantas almacenados en la nube con otros usuarios para recibir consejos y colaborar en el cuidado de mis plantas                 |      2       |
|    7    |     US14      | Historial de datos accesible en la nube          | Como usuario, necesito un historial completo y accesible en la nube de todos los datos de cuidado de mis plantas para realizar un seguimiento a largo plazo y tomar decisiones informadas                 |      2       |
|    7    |     US15      | Seguridad y privacidad de datos en la nube          | Como usuario, espero que mis datos de cuidado de plantas estén seguros y protegidos en la nube de la aplicación PlantGuard, con medidas de privacidad adecuadas para mantener la confidencialidad de mis registros                 |      2       |
